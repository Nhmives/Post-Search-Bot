...
async def start(bot, message):
    ...
    await message.reply(text=script.START.format(message.from_user.mention),
                        ...
                        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ •', url=f'https://t.me/insightweav')
            ],[InlineKeyboardButton("ʜᴇʟᴘ", url="http://telegram.me/insightweav"),

InlineKeyboardButton("ᴀʙᴏᴜᴛ", callback_data="misc_help")],[InlineKeyboardButton('• ᴏᴜʀ  ᴜᴘᴅᴀᴛᴇꜱ  ᴄʜᴀɴɴᴇʟ •', url=f'http://telegram.me/new_updet')]]))  
...
async def misc(bot, update):
    ...
    if data=="home":
       await update.message.edit(text=script.START.format(update.from_user.mention),
                                 disable_web_page_preview=True,
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ •', url=f'https://telegram.me/insightweav')
            ],[InlineKeyboardButton("ʜᴇʟᴘ", url="http://telegram.me/CodeXSupport"),

InlineKeyboardButton("ᴀʙᴏᴜᴛ", callback_data="misc_help")],[InlineKeyboardButton('• ᴏᴜʀ  ᴜᴘᴅᴀᴛᴇꜱ  ᴄʜᴀɴɴᴇʟ •', url=f'http://telegram.me/movies_Group_Nh0')]])) 
    elif data=="help":
       await update.message.edit(text=script.HELP, 
                                 disable_web_page_preview=True,
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ  ᴛᴏ  ᴏᴡɴᴇʀ',url='https://telegram.me/insightweav')],[InlineKeyboardButton("ʙᴀᴄᴋ", callback_data="misc_home"),InlineKeyboardButton("ɴᴇxᴛ", url="t.me/sewxiy")]])) 
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝  ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://telegram.me/insightweav")],[InlineKeyboardButton("ʙᴏᴛ ᴏᴡɴᴇʀ", url=f"https://telegram.me/insightweav")]]), disable_web_page_preview=True
    )
